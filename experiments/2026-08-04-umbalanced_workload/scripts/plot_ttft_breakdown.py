...
ARMS = [
    ...
    ("5: redirect_nokv_pp2", "5_redirect_nokv_pp2", 2),
    ("6: redirect_kv_pp2_c", "6_redirect_kv_pp2_c", 2),
]
...
def render_cdf_svg(
    ...
    arm_colors = {
        ...
        "5: redirect_nokv_pp2": "#4f83c2",
        "6: redirect_kv_pp2_c": colors["Compute / prefill"],
    }
