...
RESULT_NAME="${POLICY}_M200MS_D1S_MODEL20260716"
...
run_condition \
  ...
  "prompt6000-reuse50-90s-capacity-oneshot-formula-kv-reserve-m200ms-d1s"
...
run_condition \
  ...
  "input10000-reuse05-180s-capacity-oneshot-formula-kv-reserve-m200ms-d1s"
