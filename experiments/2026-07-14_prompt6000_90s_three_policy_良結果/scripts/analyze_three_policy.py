#!/usr/bin/env python3
"""Request-paired analysis for the prompt-6000, 90-second experiment."""
...
ARRIVAL_BINS = [0, 15, 30, 45, 60, 75, 91]
ARRIVAL_LABELS = ["0-15", "15-30", "30-45", "45-60", "60-75", "75-90"]
...
def plot_paired_delta(paired, output):
    ...
    axis.set_title("Prompt 6000 / 90s: request-paired E2E TTFT delta CDF", fontsize=16, pad=14)
...
def plot_arrival_bins(paired, output):
    ...
    axis.set_title("Prompt 6000 / 90s: E2E TTFT over the arrival window", fontsize=16, pad=14)
    axis.grid(True, color="#d9d2c8", linewidth=0.8)
    axis.set_axisbelow(True)
    axis.spines[["top", "right"]].set_visible(False)
...
def plot_home_gpu(paired, output):
    ...
    axis.set_title("Prompt 6000 / 90s: mean E2E TTFT by original home cell", fontsize=16, pad=14)
