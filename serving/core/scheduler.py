        ...
        with open(output_file, mode=mode, newline='') as file:
            ...
            if not is_append:
                writer.writerow(['instance id', 'request id', 'model', 'input', 'output',
                                ...
                                'adaptive_selected_route',
                                'adaptive_predicted_local_ttft_ns',
                                'adaptive_predicted_cold_ttft_ns',
                                'adaptive_predicted_kv_ttft_ns',
                                'adaptive_predicted_selected_ttft_ns',
                                'adaptive_target_reserved_kv_bytes',
                                'adaptive_target_reserved_prefill_tokens',
                                'oneshot_selected_route', 'oneshot_decision_reason',
                                'oneshot_decision_time_ns', 'oneshot_predicted_local_wait_ns',
                                'oneshot_predicted_local_ttft_ns',
                                'oneshot_predicted_redirect_ttft_ns',
                                'oneshot_redirect_margin_ns', 'oneshot_max_local_wait_ns',
                                'oneshot_target_admissible',
                                'oneshot_target_reservation_enabled',
                                'oneshot_prediction_model',
                                'oneshot_formula_local_route_probability',
                                'oneshot_formula_local_route_positive_ms',
                                'oneshot_formula_local_route_ms',
                                'oneshot_formula_local_scheduler_ms',
                                'oneshot_formula_local_compute_ms',
                                'oneshot_formula_redirect_route_probability',
                                'oneshot_formula_redirect_route_positive_ms',
                                'oneshot_formula_redirect_route_ms',
                                'oneshot_formula_redirect_scheduler_ms',
                                'oneshot_formula_redirect_compute_ms',
            ...
            for req in self.done:
                writer.writerow([
                    ...
                    req.adaptive_selected_route,
                    req.adaptive_predicted_local_ttft_ns,
                    req.adaptive_predicted_cold_ttft_ns,
                    req.adaptive_predicted_kv_ttft_ns,
                    req.adaptive_predicted_selected_ttft_ns,
                    req.adaptive_target_reserved_kv_bytes,
                    req.adaptive_target_reserved_prefill_tokens,
                    req.oneshot_selected_route,
                    req.oneshot_decision_reason,
                    req.oneshot_decision_time_ns,
                    req.oneshot_predicted_local_wait_ns,
                    req.oneshot_predicted_local_ttft_ns,
                    req.oneshot_predicted_redirect_ttft_ns,
                    req.oneshot_redirect_margin_ns,
                    req.oneshot_max_local_wait_ns,
                    req.oneshot_target_admissible,
                    req.oneshot_target_reservation_enabled,
                    req.oneshot_prediction_model,
                    req.oneshot_formula_local_route_probability,
                    req.oneshot_formula_local_route_positive_ms,
                    req.oneshot_formula_local_route_ms,
                    req.oneshot_formula_local_scheduler_ms,
                    req.oneshot_formula_local_compute_ms,
                    req.oneshot_formula_redirect_route_probability,
                    req.oneshot_formula_redirect_route_positive_ms,
                    req.oneshot_formula_redirect_route_ms,
                    req.oneshot_formula_redirect_scheduler_ms,
                    req.oneshot_formula_redirect_compute_ms,
